...
<head>
    ...
    <title>TechStore - @yield('title', 'Ưu Đãi Công Nghệ Hàng Đầu')</title>
    ...
    <style>
        ...
        .badge-cart { background-color: var(--accent); font-size: 0.7rem; }
        ...
        footer h5 { font-weight: 700; margin-bottom: 1.5rem; font-size: 1.1rem; }
        footer a { color: #94a3b8; text-decoration: none; display: block; margin-bottom: 0.8rem; transition: color 0.2s; }
        footer a:hover { color: #fff; }
        footer .social-icon { font-size: 1.2rem; margin-right: 1rem; color: #94a3b8; }
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <div class="d-flex align-items-center gap-3">
                ...
                @guest
                    <a href="{{ route('login') }}" class="btn btn-outline-primary rounded-pill px-4">Đăng Nhập</a>
                    <a href="{{ route('register') }}" class="btn btn-primary rounded-pill px-4">Đăng Ký</a>
                @else
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end border-0 shadow-lg rounded-3 mt-2">
                            ...
                            <li>
                                <form action="{{ route('logout') }}" method="POST">
                                    @csrf
                                    <button class="dropdown-item py-2 text-danger" type="submit"><i class="bi bi-box-arrow-right me-2"></i>Đăng Xuất</button>
                                </form>
                            </li>
                        </ul>
                    </div>
    ...
    <div class="container">
        <div class="row g-4">
            <div class="col-lg-4">
                ...
                <p class="text-muted mb-4">Điểm đến hàng đầu cho công nghệ mới nhất. Chúng tôi cung cấp thiết bị chất lượng với dịch vụ xuất sắc.</p>
            ...
            <div class="col-lg-4">
                ...
                <p class="text-muted small">Đăng ký nhận bản tin để cập nhật công nghệ mới và ưu đãi độc quyền.</p>
        ...
        <div class="border-top border-secondary mt-5 pt-4 text-center text-muted small">
            <p>&copy; {{ date('Y') }} TechStore. Bảo lưu mọi quyền.</p>
        </div>
    </div>
</footer>
