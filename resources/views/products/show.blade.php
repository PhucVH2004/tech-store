        ...
        <div class="col-lg-6">
            <div class="mb-4">
                ...
                <div class="d-flex align-items-center gap-3 mb-4">
                    <h2 class="text-accent fw-bold m-0">${{ number_format($product->price, 2) }}</h2>
                    @if($product->stock > 0)
                ...
                <ul class="nav nav-pills mb-4" id="pills-tab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active rounded-pill px-4" id="pills-desc-tab" data-bs-toggle="pill" data-bs-target="#pills-desc" type="button" role="tab">Description</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link rounded-pill px-4" id="pills-specs-tab" data-bs-toggle="pill" data-bs-target="#pills-specs" type="button" role="tab">Specifications</button>
                    </li>
                </ul>
